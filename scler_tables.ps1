...
$rankKeyTable = @{
    ...
    'mg_battaglia_RepScope_Rank1'            = 'Associate'
    'mg_battaglia_RepScope_Rank2'            = 'Trusted Associate'
    'mg_battaglia_RepScope_Rank3'            = 'Prestige 1'
    'mg_battaglia_RepScope_Rank4'            = 'Prestige 2'
    'mg_battaglia_RepScope_Rank5'            = 'Prestige 3'
    'Neutral'                                = 'Neutral'
}
